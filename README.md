...
NOTE: This is a translation of the [original repository](https://github.com/thiadeliria/Pacman), written in Python 2, to Python 3. Mainly done automatically via the [`2to3`](https://docs.python.org/3/library/2to3.html) library, with a few manual changes here and there. All the commands below should be functional. All credit for the original implementation goes to [`thiadeliria`](https://github.com/thiadeliria) and the [CS188 staff](https://cs188.ml).
...
<p align="center">
<img src="/gifs/interactive.gif" width="540" />
</p>
